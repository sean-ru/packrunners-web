...
public class PackrunnersModuleVersionHandler extends DefaultModuleVersionHandler {
  ...
  public PackrunnersModuleVersionHandler() {
        ...
        .addTask(new IsInstallSamplesTask("Re-Bootstrap website content for packrunners pages",
            ...
            new ArrayDelegateTask("",
                new BootstrapSingleResource("", "",
                        "/mgnl-bootstrap-samples/packrunners/website.packrunners.yaml"),
                new BootstrapSingleResource("", "",
                        "/mgnl-bootstrap-samples/packrunners/dam.packrunners.xml",
    ...
    register(DeltaBuilder.update("0.0.2", "")
        .addTask(new BootstrapSingleResourceAndOrderAfter(
            ...
            "Bootstrap addCORSHeaders filter to be /.rest/* urls available via CORS",
                "/mgnl-bootstrap/packrunners/config.server.filters.addCORSHeaders.xml", "uriSecurity"))
    );
