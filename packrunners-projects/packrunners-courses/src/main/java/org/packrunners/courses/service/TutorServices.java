...
public class TutorServices {
  ...
  @Inject
  public TutorServices(CoursesModule coursesModule, TemplateTypeHelper templateTypeHelper,
  ...
  public Node getTutorNodeByParameter() throws RepositoryException {
    final String tutorName = StringUtils
        .defaultIfBlank(MgnlContext.getParameter(TUTOR_QUERY_PARAMETER),
            coursesModule.getDefaultTutorName());
    return getContentNodeByName(tutorName, CoursesModule.COURSES_REPOSITORY_NAME);
  }
